        ...
        <div className="footer-grelha">
          ...
          <div>
            ...
            <div className="footer-redes">
              <a href="#" className="footer-rede" aria-label="Instagram">
                <IconeInstagram />
              </a>
              <a href="#" className="footer-rede" aria-label="Facebook">
                <IconeFacebook />
              </a>
              <a href="#" className="footer-rede" aria-label="LinkedIn">
                <IconeLinkedIn />
              </a>
            </div>
          </div>
